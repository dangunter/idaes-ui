describe('loads the app UI correctly', () => {
	...
	it('check app #header exists', { retries: retryTimes }, () => {
		cy.get('#header').should('exist');
	})

	//check flowsheet component exists
	it('check app #flowsheet-wrapper exists', { retries: retryTimes }, () => {
		cy.get('#flowsheet-wrapper').should('exist');
	})

	//check stream table component exists
	it('check app #stream-table exist', { retries: retryTimes }, () => {
